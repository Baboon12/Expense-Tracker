    ...
    <div className="">
      {props.clicked ? (
        // <div className="lg:w-3/4 w-[90%] ml-5 lg:ml-14 py-4 lg:py-10 lg:m-auto lg:mt-10  bg-rp-black lg:p-5 rounded-md">
          <div className="lg:w-3/4 w-[90%] ml-5 lg:ml-14 lg:m-auto lg:mt-10  bg-rp-black rounded-md">
            ...
            <ul className="flex  lg:pb-0 pb-8 lg:px-0 lg:-ml-10 space-x-3 lg:space-x-10">
              <button onClick={changeButton1}>
                <li
                  className={
                    active === "1"
                      ? "bg-mj-pink py-3 px-5 rounded-md text-rp-black font-bold"
                      : "border border-mj-pink py-3 px-5 rounded-md text-mj-pink font-bold "
                  }
                >
                  1 Month
                </li>
