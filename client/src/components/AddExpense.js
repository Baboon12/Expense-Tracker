    ...
    <Scrollbars style={{ width: 540, height: 500 }} className="mt-8">
      <div className=" grid grid-cols-6 font-lexend ">
        <div className="col-span-4 bg-rp-black p-6 ">
          ...
          <div>
            <input
              className="p-3 px-4 rounded-md mt-6  w-3/4 placeholder-rp-pink bg-jp-black outline-none text-jp-white"
          ...
          <div className="border-rp-pink border-2 rounded-md w-fit px-8 mt-10">
            {isLoading ? (
              <ReactLoading
                type="bubbles"
                color="#F5A302"
              ...
              <button
                ...
                className="font-bold text-jp-pink py-4"
              >
                Save Expense
              </button>
            )}
