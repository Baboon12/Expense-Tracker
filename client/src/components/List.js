...
export default function List(props) {
  ...
  return (
    <div className="m-2 mt-4 lg:mt-0 mx-4 lg:mx-0 p-2  lg:grid lg:grid-cols-7  text-slate-300 bg-rp-black rounded-xl lg:p-4 lg:m-6 lg:w-[90%] w-[65%] flex">
      <div
        onClick={HandleSetUp}
        className="text-jp-pink absolute cursor-pointer"
      >
        <svg
      ...
      <div className="lg:col-span-4 ml-3 lg:ml-0 mt-2 lg:mt-2 ">
        <div className="flex">
          <div className="flex text-jp-pink bg-jp-black rounded-xl w-fit px-2 py-1 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              viewBox="0 0 20 20"
          ...
          <div className="flex text-jp-pink bg-jp-black rounded-xl w-fit px-2 py-1 ml-3 ">
